          ...
          <div className='project-detail-featured'>
            {heroMedia.type === 'video' ? (
              ...
              <div className='project-detail-youtube'>
                {heroIsPlaying ? (
                  <iframe
                    src={getYouTubeEmbedUrl(heroMedia.src, { autoplay: !reduceMotion })}
                    title={heroMedia.alt}
              ...
              if (media.type === 'image') {
                ...
                content = (
                  <div className='project-detail-youtube'>
                    {isPlaying ? (
                      <iframe
                        src={getYouTubeEmbedUrl(media.src, { autoplay: !reduceMotion })}
                        title={media.alt}
                        allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'
                        allowFullScreen
                      />
...
const ProjectDetail: React.FC = () => {
  ...
  const seoTitle = project ? `${project.title} Project` : 'Project Not Found';
  const seoDescription = project
    ? `${project.tagline} Built by ${siteConfig.name}.`
    : 'The requested project could not be found on Nur Mohammad Farazi portfolio.';
    ...
    return (
      <>
        <Seo
          ...
          path={seoPath}
          type='article'
          keywords={['project not found', 'portfolio project']}
        />
        <article className='project-detail-page'>
          <div className='project-detail-topbar'>
            <Link to='/projects' className='project-detail-back'>
